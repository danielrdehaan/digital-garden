---
canvas_title: "Week-08: Production Techniques"
canvas_sync: true
canvas_publish: true
canvas_type: page
...
**Reference Workflow**
1. Import reference to project (muted)
2. Match loudness to your mix
3. A/B frequently during mixing
4. Compare specific elements (bass, vocals, etc.)
5. Note differences and adjust
...
- [[Mastering Overview]]
- [Reference Track Matching (YouTube)](https://www.youtube.com/results?search_query=reference+mixing+tutorial)
...
3. **Supporting element automation**
...
**Deliverable:**
Polished mix with documented automation moves and reference comparison notes.
