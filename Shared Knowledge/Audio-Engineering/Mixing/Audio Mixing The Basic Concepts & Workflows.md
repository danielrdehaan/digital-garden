---
title: Audio Mixing The Basic Concepts & Workflows
type: knowledge
status: active
tags:
  - "#type/tutorial"
...
[Mixing Example Files - Let's Go to the Movies.zip](Mixing_Example_Files_-_Lets_Go_to_the_Movies.zip)

[Mix Examples Files - Mello Is As Yello Does.zip](Mix_Examples_Files_-_Mello_Is_As_Yello_Does.zip)

🌊 [Billie Eilish - Ocean Eyes](https://www.dropbox.com/scl/fi/twivqw9ovszdwzg7lhqi1/Billie-Eilish_Ocean-Eyes_Multitrack.zip?rlkey=71slq19jiyj5nmjd2inbbi5dg&st=3sgztq6y&dl=0) 👀 👈 Email me for the password to download this if you are one of my CCC Students

🏥 [Chuck Sutton - Patience](https://www.dropbox.com/scl/fi/ee1rpyub2hrl8yigkchms/Chuck-Sutton_Patience_Multitracks.zip?rlkey=awyx2kxyt8zrx2cb7u44pry7m&st=1yf7cufu&dl=0) 👈 Email me for the password to download this if you are one of my CCC Students

**Additional Multi-track Recording for practicing mixing can be downloaded from [here](https://my.lewitt-audio.com/downloads).**
...
![Screen Shot 2021-09-29 at 9.00.22 AM.png](Screen_Shot_2021-09-29_at_9.00.22_AM.png)
...
1. Frequency (Tool = EQ)
2. Depth (Tool = Reverb)
3. Stereo Field (Tool = Pan)

> [!note]
> [The Art of Mixing](https://youtu.be/TEjOdqZFvhY), [3D Mixing](https://music.tutsplus.com/series/3d-mixing--audio-21430)
...
> [!note]
> [Logic Pro: Channel EQ](https://support.apple.com/guide/logicpro/channel-eq-overview-lgcef1edce5b/mac), [Ableton Live: EQ Eight](https://www.ableton.com/en/manual/live-audio-effect-reference/#24-15-eq-eight), [Reaper: ReaEQ](https://www.youtube.com/watch?v=cix4K9ACzEo&ab_channel=REAPERMania)
...
> [!note]
> [Logic Pro](https://www.youtube.com/watch?v=lJkpjp55Ejo&ab_channel=MusicTechHelpGuy), [Ableton Live](https://www.youtube.com/watch?v=0ZHySX8wfEc&ab_channel=StatikSessions), [Reaper](https://www.youtube.com/watch?v=KhK8UGYRXXc&ab_channel=REAPERMania)
...
- Begin by lowering all your tack's volume sliders to `-inf` then raise the level of the most important element to a comfortable listen level
- Moving on to the second most important element, raise the volume until it is too loud relative to your first sound. Then lower it until it is too quiet. Keep swinging back and forth between too loud and too quiet until you find the sweet spot.
- Repeat this for every single sound
- Keep an eye on your Master track's meter. If the meter is going above `-6 dB`, uniformly reduce the volume of all of your tracks until the meters are peaking back below `-6 dB`.
...
> [!note]
> ![](https://youtu.be/1ormfTMYfv0?si=vF8Yg_1NNHUxgnAG)

# Mixing Demo

![](https://youtu.be/3914VpGfiCs)

![](https://youtu.be/i9WXuQpmMM0)

![](https://youtu.be/CpeyNpi61Q0)